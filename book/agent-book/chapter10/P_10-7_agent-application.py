...
def main(user_request, persona_n):
    import argparse
    ...
    # 要件定義書生成AIエージェントを初期化
    agent = DocumentationAgent(llm=llm, k=persona_n)
...
if __name__ == "__main__":
    # 実行
    user_request = "スマートフォン向けの健康管理アプリを開発したい"
    persona_n = 3
    main(user_request=user_request, persona_n=persona_n)
